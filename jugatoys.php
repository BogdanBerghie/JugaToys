...
function configuracionInicial(){
  ...
  //IDEA: Únicamente debería hacerse una vez, después siempre se actualizará en base a la última fecha de actualización (así se reduce la carga de las consultas). Para realizar esto estaría bien crear una option, con un valor booleano. 

  //Todo: crear cron para sincronización de stock
  //IDEA: Esta sincronización de stock de todos los productos se debe lanzar X veces diariamente (configurable en las opciones). De deberían de ir consultando productos de X en X (¿Convendría que fuese configurable en opciones?). 
